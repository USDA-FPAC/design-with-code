import{_ as H,d as x,a as C,r as d,u as T,c as z,w as A,k as E,o as B,e as L,l as t,x as M,y as V,s as m}from"./index.507ccdf8.js";import{u as P}from"./useNavigation.e716b155.js";import{v as h,u as S}from"./useGrowlControls.f9527e41.js";function N(){return{footer:`<footer id="dwc-${h()}">
...
</html>`}}const G=x(()=>C(()=>import("./BaseHeader.88883a97.js"),["assets/BaseHeader.88883a97.js","assets/disclaimer.f7d8f248.js","assets/index.507ccdf8.js","assets/index.d9429370.css","assets/useNavigation.e716b155.js"])),D={components:{baseHeader:G},setup(c,{emit:e}){const n=d("/design-with-code/"),a=T(),{goto:_}=P(),{showSuccessGrowl:f,showErrorGrowl:o}=S(),{footer:v,end:g}=N(),u=z(()=>{let s=a.getters["codeExport/getHtml"];return s||null}),i=d(),p=()=>{let s=i.value,l=`/>

import{_ as H,d as x,a as C,r as d,u as T,c as z,w as A,k as E,o as B,e as L,l as t,x as M,y as V,s as m}from"./index.4efb4425.js";import{u as P}from"./useNavigation.19b233b5.js";import{u as S}from"./useGrowlControls.5be3ae75.js";import{v as h}from"./v4.83dbd2d9.js";function N(){return{footer:`<footer id="dwc-${h()}">
...
</html>`}}const G=x(()=>C(()=>import("./BaseHeader.0e484bb7.js"),["assets/BaseHeader.0e484bb7.js","assets/disclaimer.cb2fcd6b.js","assets/index.4efb4425.js","assets/index.d9429370.css","assets/useNavigation.19b233b5.js"])),D={components:{baseHeader:G},setup(c,{emit:e}){const n=d("/design-with-code/"),a=T(),{goto:_}=P(),{showSuccessGrowl:f,showErrorGrowl:o}=S(),{footer:v,end:g}=N(),u=z(()=>{let s=a.getters["codeExport/getHtml"];return s||null}),i=d(),p=()=>{let s=i.value,l=`/>

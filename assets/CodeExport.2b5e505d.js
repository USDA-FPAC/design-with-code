import{_ as H,d as x,a as C,r as d,u as T,c as z,w as A,k as E,o as B,e as L,l as t,x as M,y as V,s as m}from"./index.91e90bd4.js";import{u as P}from"./useNavigation.99f33b57.js";import{v as h,u as S}from"./useGrowlControls.22687e0d.js";function N(){return{footer:`<footer id="dwc-${h()}">
...
</html>`}}const G=x(()=>C(()=>import("./BaseHeader.eeaf7dad.js"),["assets/BaseHeader.eeaf7dad.js","assets/disclaimer.f812ad1b.js","assets/index.91e90bd4.js","assets/index.d9429370.css","assets/useNavigation.99f33b57.js"])),D={components:{baseHeader:G},setup(c,{emit:e}){const n=d("/design-with-code/"),a=T(),{goto:_}=P(),{showSuccessGrowl:f,showErrorGrowl:o}=S(),{footer:v,end:g}=N(),u=z(()=>{let s=a.getters["codeExport/getHtml"];return s||null}),i=d(),p=()=>{let s=i.value,l=`/>
